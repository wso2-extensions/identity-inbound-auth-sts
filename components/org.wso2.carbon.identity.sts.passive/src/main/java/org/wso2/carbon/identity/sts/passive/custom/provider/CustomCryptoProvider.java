...
public class CustomCryptoProvider extends Merlin {
    ...
    public CustomCryptoProvider(Properties properties, ClassLoader loader, PasswordEncryptor passwordEncryptor) throws WSSecurityException, IOException {
    ...
    protected KeyStore load(InputStream input, String storepass, String provider, String type)
        ...
        if (tenantId != null && Integer.parseInt(tenantId) != MultitenantConstants.SUPER_TENANT_ID
                && keyStoreName != null) {
